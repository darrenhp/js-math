  ...
  function renderWelcome() {
    ...
    contentInner.innerHTML =
      `<div class="welcome">
        ...
        <p class="lead">一站式浏览 ${LIBS.length} 个前端数学库，覆盖 ${CATS.length} 个分类：通用计算、符号计算 / 逻辑代数、线性代数 / 矩阵 / 稀疏、统计学、概率随机数、几何 / 空间计算、机器学习、信号处理 / 时间序列、微积分 / 数值求解、图论、单位换算、数论 / 特殊数制、数学函数 / 特殊函数、密码学、金融数学、插值 / 拟合 / 样条、可视化 / 分形、GPU 加速等。每个库都配有<strong>可实时运行、可交互调参</strong>的 Demo 与可视化。点击左侧任意库开始探索。</p>
        <div class="stat-row">
